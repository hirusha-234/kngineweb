    ...
    <footer className="py-20 md:py-32 px-4 md:px-8 lg:px-16 bg-black">
      <div className="max-w-[1200px] mx-auto">
        <div className="flex flex-col md:flex-row rounded-[40px] overflow-hidden min-h-[500px] shadow-2xl">
          ...
          <div className="w-full md:w-[60%] bg-[#D1D5DB] p-10 md:p-16 flex flex-col justify-between text-[#0B0B0B]">
            <div>
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-4">
                ...
                <div className="flex flex-col gap-3">
                  <a href="#" className="text-sm font-bold hover:opacity-60 transition-opacity">Terms & Conditions</a>
                  <a href="#" className="text-sm font-bold hover:opacity-60 transition-opacity">Privacy Policy</a>
                  <a href="#" className="text-sm font-bold hover:opacity-60 transition-opacity">Cookie Policy</a>
                </div>
              </div>
            </div>
          ...
          <div className="w-full md:w-[40%] bg-black p-10 md:p-16 flex flex-col justify-between text-white">
            <div>
            <img src="/rits.png" alt="" />
